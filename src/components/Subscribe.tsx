...
const Subscribe = () => {
  return (
    <section className="flex flex-col items-center px-5 py-20">
      <h1
        className={`${tomorrow.className} sm:text-[2.5rem] mb-20 font-semibold text-center text-[#D60B42]`}
      >
      ...
      >
        ...
        />
        <button
          className="w-24 sm:w-32 h-full max-sm:text-sm bg-[#F70CC1] text-white rounded-e-full"
          type="submit"
        >
          Get News
        </button>
